...
| Phase status | 🟡 **In progress.** The two module suites that were never written now exist, and every endpoint is asked to refuse an unauthenticated caller rather than merely declaring that it would. |
