...
| 79 | Employee custom attributes have no screen | Low | The API sets, reads and removes them; the employee screen does not show them. Lower than #78 was for webhooks, because an attribute's audience is the business application that wrote it rather than an administrator — but "what do you hold about this person" is a question a person asks, and today it is answered by an API call. |
