...
export type WorkflowTaskDto = Schemas['WorkflowTaskDto'];
export type WorkflowInstanceDto = Schemas['WorkflowInstanceDto'];
export type WorkflowDefinitionDto = Schemas['WorkflowDefinitionDto'];
